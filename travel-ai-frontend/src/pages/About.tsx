      ...
      <div style={{ 
        ...
        <div style={{ backgroundColor: '#111827', color: '#ffffff', padding: '40px 30px', borderRadius: '16px', textAlign: 'center', marginBottom: '40px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', flexWrap: 'wrap' }}>
            ...
            <a href="https://github.com/Tochiiy" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#93c5fd', textDecoration: 'none', fontWeight: '500', fontSize: '1.1rem' }}>
